...
contract CrossChain is Test {
    ...
    CCIPLocalSimulatorFork public cciplsf;
    ...
    function setUp() public {
        ...
        cciplsf = new CCIPLocalSimulatorFork();
        vm.makePersistent(address(cciplsf));

        sepoliaNetworkDetails = cciplsf.getNetworkDetails(block.chainid);
        vm.startPrank(owner);
        ...
        vm.startPrank(owner);
        arbSepoliaNetworkDetails = cciplsf.getNetworkDetails(block.chainid);
    ...
    function bridgeTokens(
        ...
        cciplsf.switchChainAndRouteMessage(remoteFork);
        uint256 remoteBalaceAfter = remoteToken.balanceOf(user);
        assertEq(remoteBalaceAfter, remoteBalanceBefore + amountToBridge);
    }
